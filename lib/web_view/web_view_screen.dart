...
class _WebViewScreenState extends WebViewWidgets {
  @override
...
abstract class WebViewWidgets extends State<WebViewScreen> with WidgetsBindingObserver {
  ...
  Widget _screenView({required BuildContext context}) {
    return SizedBox(
